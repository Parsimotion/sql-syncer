...
module.exports = (grunt) ->
  ...
  azureWebsite = "sql-syncer" + if process.env.BRANCH_NAME is "master" then "" else "-#{process.env.BRANCH_NAME}"
  azureGit = "#{azureWebsite}.scm.azurewebsites.net:443/sql-syncer.git"
